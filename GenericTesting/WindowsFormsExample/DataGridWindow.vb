Public Class DataGridWindow
  ...
  Private Sub PopulateDataGridView()
    With Me.DataGridView1
      ...
      .Columns("Description").SortMode =
          DataGridViewColumnSortMode.NotSortable
      .Columns("Withdrawals").SortMode =
          DataGridViewColumnSortMode.NotSortable
      .Columns("Deposits").SortMode =
          DataGridViewColumnSortMode.NotSortable
      .Columns("Balance").SortMode =
          DataGridViewColumnSortMode.NotSortable
    End With
  ...
  Private Sub RowsRemoved(ByVal sender As Object,
  ...
  Private Sub SelectionChanged(ByVal sender As Object, ByVal e As EventArgs) Handles DataGridView1.SelectionChanged
    ' Update the labels to reflect changes to the selection.
    UpdateLabelText()
  End Sub

  Private Sub UserAddedRow(ByVal sender As Object,
  ...
  Private Sub UpdateLabelText()
    ...
    For counter = 0 To (DataGridView1.SelectedCells.Count - 1)
      If DataGridView1.SelectedCells(counter).FormattedValueType Is
  ...
  Private Sub CellValidating(ByVal sender As Object,
  ...
  Private Sub CellValidated(ByVal sender As Object,
