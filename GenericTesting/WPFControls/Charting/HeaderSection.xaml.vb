...
#Region "ChartTitle"
  Public Shared ReadOnly ChartTitleProperty As DependencyProperty = DependencyProperty.Register("ChartTitle", GetType(String), GetType(HeaderSection), New UIPropertyMetadata(String.Empty))
...
#End Region
  ...
  '  Public Shared ReadOnly ChartTitleForegroundProperty As DependencyProperty = DependencyProperty.Register("ChartTitleForeground", GetType(Brush), GetType(HeaderSection), New UIPropertyMetadata(Brushes.Black))
  ...
  '  Public Shared ReadOnly ChartTitleHiddenProperty As DependencyProperty = DependencyProperty.Register("ChartTitleHidden", GetType(Boolean), GetType(HeaderSection), New UIPropertyMetadata(False, AddressOf HeaderSection.ChartTitleHiddenChanged))
