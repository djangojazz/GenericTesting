...
,('AAAAA', NULL, GETDATE(), GETDATE(), 0),('AAAAAA', NULL, GETDATE(), GETDATE(), 0),('AAAAAAA', NULL, GETDATE(), GETDATE(), 1),('BBBBBB', 13, GETDATE(), GETDATE(), 1)
,('CCCCCCC', 14, GETDATE(), GETDATE(), 1),('DDDDDDD', 15, GETDATE(), GETDATE(), 1),('AAAAAAAA', NULL, GETDATE(), GETDATE(), 1),('AAAAAAAAA', NULL, GETDATE(), GETDATE(), 1)
,('AAAAAAAAAA', NULL, GETDATE(), GETDATE(), 1),('AAAAAAAAAAA', NULL, GETDATE(), GETDATE(), 1),('AAAAAAAAAAAA', NULL, GETDATE(), GETDATE(), 1),('AAAAAAAAAAAAA', NULL, GETDATE(), GETDATE(), 1)
